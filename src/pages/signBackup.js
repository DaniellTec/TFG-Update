      ...
      <div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
          <div class="bg-light p-5 border shadow">
              ...
              <form>                
                  ...
                  <div class="mb-4">
                    <div class="buttonIn">
                      <input  type="password" id="typePasswordX" class="form-control form-control-lg"  placeholder="Enter password" required="Passwordd" type= {this.state.showPassword ? "text" : "password" } />
                      <br/>
                      <input  type="password" id="typePasswordX" class="form-control form-control-lg" required="Confirm Password"  placeholder="Confirm password" type= {this.state.showPassword ? "text" : "password" } />
                      <br/>
