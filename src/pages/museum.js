        ...
        {this.state.data.map(museumData=>{
          ...
          <div className="boxMuseum" >
            ...
            <img src = {museumData.image} width="275" className="imageProduct"/>
                ...
                <div>
                  <button className="btn btn-primary" onClick={()=>{this.seleccionarMuseo(museumData); this.modalInsertar()}}><BiInfoSquare/></button>
              </div>
            </div>
          </div>
          )
             ...
             <Modal isOpen={this.state.modalInsertar}>
                ...
                <ModalBody>
                  ...
                  <div className="form-group">
                    ...
                    <input className="form-control" type="text" name="location" id="web" height="48" onChange={this.handleChange} value={form?form.web:''}/>
                  </div>
                </ModalBody>
                ...
                <ModalFooter>
                  {this.state.tipoModal=='insertar'?
                   ...
                   <button className="btn btn-dark" onClick={()=>this.modalInsertar()}>Guardar</button>
                  }
