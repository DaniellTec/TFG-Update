...
class Museumm extends Component {
  constructor(props) {
    super(props)
    this.state={
    data:[],
    ...
    &nbsp;  Fotografías en venta
      ...
      &nbsp;&nbsp;&nbsp;&nbsp; <select class="btn btn-light" id="price-filter" value={value} onChange={this.handleChange1}>
          &nbsp;<option value="Sort">Ordenar por destacados</option>
            <option value="Low review">Reviews: de más bajo a más alto</option>
            <option value="High review">Reviews: de más alto a más bajo</option>
          </select>
          <input type="submit" value="OK" class="btn btn-dark" /> &nbsp;
          <button className="btn btn-success" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar Museo</button>
        </form>
    <section>
